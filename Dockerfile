...
RUN install.r shiny rmarkdown flexdashboard dplyr stringr vroom fontawesome reactable purrr explore plotly visdat shinyWidgets leafem sf leaflet leaflet.extras spsComps bspm mapview
